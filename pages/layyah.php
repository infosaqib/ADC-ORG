...
<head>
    ...
    <title>Army Dog Center Layyah | 03332874135</title>
    <meta name="description" content="Professional dog services in Layyah - 24/7 emergency response.">
    ...
    <meta property="og:title" content="Army Dog Center Layyah | 03332874135" />
    <meta property="og:description" content="        
            ...
            ">
    <meta property="og:url" content="https://services.armydogcenter.org.pk/layyah.php" />
    <meta property="og:type" content="website" />
    <meta property="og:image" content="https://armydogcenter.org.pk/images/services/layyah.jpeg" />
    <meta property="og:site_name" content="Army Dog Center Pakistan" />

    <!-- Twitter Card -->
    <meta name="twitter:card" content="summary" />
    <meta name="twitter:title" content="Army Dog Center Layyah | 03332874135" />
    <meta name="twitter:description" content="        
             چوری، ڈکیتی، قتل اور اغوا جیسے جرائم کے خلاف فوری مدد کے لیے ہمہ وقت دستیاب۔ ہمارے ماہر کتے جرائم کے نشانات ڈھونڈنے اور اہم شواہد فراہم کرنے میں مددگار ثابت ہوتے ہیں۔ ہم 24/7 ہر جگہ خدمات فراہم کرتے ہیں تاکہ آپ کو مکمل تحفظ اور اطمینان حاصل ہو۔
             
            ">
    <meta name="twitter:image" content="https://armydogcenter.org.pk/images/services/layyah.jpeg" />

    <!-- Favicon -->
    <link rel="apple-touch-icon" href="https://armydogcenter.org.pk/images/logo.webp" />
    <link rel="canonical" href="https://services.armydogcenter.org.pk/layyah.php" />
    ...
    <script type="application/ld+json">
    {
        ...
        "@graph":[
            ...
            {
                "@type":"WebPage",
                "@id":"https://services.armydogcenter.org.pk/layyah.php#webpage",
                "url":"https://services.armydogcenter.org.pk/layyah.php",
                "name":"Army Dog Center Layyah",
                "description":"Professional dog services in Layyah including crime investigation, evidence detection, and security services with trained dogs available 24/7.",
...
<body class="bg-gray-50 font-sans">
    <header class="text-white p-8 text-center shadow-lg h-[35vh] flex items-center justify-center"
        ...
        <div class="container mx-auto">
            ...
            <h2 class="text-3xl md:text-4xl font-semibold">Layyah<br> 03332874135</h2>
        </div>
    </header>
    <main class="max-w-4xl mx-auto p-4 md:p-8">
        ...
        <div class="mb-10">
            <div data-aos="fade-up" class="bg-gradient-to-r from-cyan-50 to-blue-50 rounded-xl p-6 shadow-md">
                <h3 class="text-center text-teal-500 font-bold text-2xl mb-6">Contact Numbers</h3>
            ...
            <div class="bg-white p-2 rounded-xl shadow-md">
                ...
                <div class="flex justify-center">
                    <div
                        ...
                        <img src="https://armydogcenter.org.pk/images/services/layyah.jpeg" alt="German Shepherd Dog"
                        ...
                        <div
                            ...
                            <h4 class="text-xl font-bold">Professional K-9 Unit Layyah</h4>
                            <p class="text-sm">
                                Our highly trained dogs are experts in detection and tracking in Layyah
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden">
                <div class="bg-gradient-to-r from-teal-500 to-teal-300 py-4 px-6">
                    <h3 class="text-white text-center text-2xl font-bold">
                        Our Professional Services in Layyah
                    </h3>
                </div>
        ...
        <div data-aos="fade-up" class="mb-10">
            <div class="bg-gradient-to-r from-teal-500 to-teal-300 rounded-xl p-8 shadow-lg text-center">
                <h3 class="text-white text-2xl font-bold mb-4">
                    Need Professional Dog Services in Layyah?
                </h3>
                <p class="text-cyan-100 mb-6 max-w-lg mx-auto">
                    Our team is available 24/7 to assist with any emergency situation in Layyah.
