...
<head>
    ...
    <meta property="og:description" content="        
            ...
            ">
    <meta property="og:url" content="https://services.armydogcenter.org.pk/shikarpur.php" />
    <meta property="og:type" content="website" />
    <meta property="og:image" content="https://armydogcenter.org.pk/images/services/sindh/shikarpur.jpeg" />
    ...
    <meta name="twitter:description" content="        
            ...
            ">
    <meta name="twitter:image" content="https://armydogcenter.org.pk/images/services/sindh/shikarpur.jpeg" />
    ...
    <link rel="canonical" href="https://services.armydogcenter.org.pk/shikarpur.php" />
    ...
    <script type="application/ld+json">
    {
        ...
        "@graph":[
            ...
            {
                "@type":"WebPage",
                "@id":"https://services.armydogcenter.org.pk/shikarpur.php#webpage",
                "url":"https://services.armydogcenter.org.pk/shikarpur.php",
                "name":"Army Dog Center Shikarpur",
                "description":"Professional dog services in Shikarpur",
            ...
            <div class="bg-white p-2 rounded-xl shadow-md">
                ...
                <div class="flex justify-center">
                    <div
                        ...
                        <img src="https://armydogcenter.org.pk/images/services/sindh/shikarpur.jpeg" alt="German Shepherd Dog"
                        ...
                        <div
                            ...
                            <h4 class="text-xl font-bold">Professional K-9 Unit Shikarpur</h4>
                            <p class="text-sm">
                                Our highly trained dogs are experts in detection and tracking in Shikarpur
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden">
                <div class="bg-gradient-to-r from-teal-500 to-teal-300 py-4 px-6">
                    <h3 class="text-white text-center text-2xl font-bold">
                        Our Professional Services in Shikarpur
                    </h3>
                </div>
        ...
        <div data-aos="fade-up" class="mb-10">
            <div class="bg-gradient-to-r from-teal-500 to-teal-300 rounded-xl p-8 shadow-lg text-center">
                <h3 class="text-white text-2xl font-bold mb-4">
                    Need Professional Dog Services in Shikarpur?
                </h3>
                <p class="text-cyan-100 mb-6 max-w-lg mx-auto">
                    Our team is available 24/7 to assist with any emergency situation in Shikarpur.
