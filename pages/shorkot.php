...
<head>
    ...
    <title>Army Dog Center Shorkot | 03003006220</title>
    ...
    <meta property="og:title" content="Army Dog Center Shorkot | 03003006220" />
    <meta property="og:description" content="        
            ...
            ">
    <meta property="og:url" content="https://services.armydogcenter.org.pk/shorkot.php" />
    <meta property="og:type" content="website" />
    <meta property="og:image" content="https://armydogcenter.org.pk/images/services/shorkot.jpeg" />
    <meta property="og:site_name" content="Army Dog Center Pakistan" />

    <!-- Twitter Card -->
    <meta name="twitter:card" content="summary" />
    <meta name="twitter:title" content="Army Dog Center Shorkot | 03003006220" />
    <meta name="twitter:description" content="        
             چوری، ڈکیتی، قتل اور اغوا جیسے جرائم کے خلاف فوری مدد کے لیے ہمہ وقت دستیاب۔ ہمارے ماہر کتے جرائم کے نشانات ڈھونڈنے اور اہم شواہد فراہم کرنے میں مددگار ثابت ہوتے ہیں۔ ہم 24/7 ہر جگہ خدمات فراہم کرتے ہیں تاکہ آپ کو مکمل تحفظ اور اطمینان حاصل ہو۔
             
            ">
    <meta name="twitter:image" content="https://armydogcenter.org.pk/images/services/shorkot.jpeg" />

    <!-- Favicon -->
    <link rel="apple-touch-icon" href="https://armydogcenter.org.pk/images/logo.webp" />
    <link rel="canonical" href="https://services.armydogcenter.org.pk/shorkot.php" />
    ...
    <script type="application/ld+json">
    {
        ...
        "@graph":[
            ...
            {
                "@type":"WebPage",
                "@id":"https://services.armydogcenter.org.pk/shorkot.php#webpage",
                "url":"https://services.armydogcenter.org.pk/shorkot.php",
                "name":"Army Dog Center Shorkot",
                "description":"Professional dog services in Shorkot including crime investigation, evidence detection, and security services with trained dogs available 24/7.",
...
<body class="bg-gray-50 font-sans">
    <header class="text-white p-8 text-center shadow-lg h-[35vh] flex items-center justify-center"
        ...
        <div class="container mx-auto">
            ...
            <h2 class="text-3xl md:text-4xl font-semibold">Shorkot<br> 03003006220</h2>
        </div>
    </header>
    <main class="max-w-4xl mx-auto p-4 md:p-8">
        ...
        <div class="mb-10">
            <div data-aos="fade-up" class="bg-cyan-50 rounded-xl p-6">
                <h3 class="text-teal-500 font-bold text-2xl mb-6 text-center">Contact</h3>
            ...
            <div class="bg-white p-2 rounded-xl shadow-md">
                ...
                <div class="flex justify-center">
                    <div
                        ...
                        <img src="https://armydogcenter.org.pk/images/services/shorkot.jpeg" alt="German Shepherd Dog"
                        ...
                        <div
                            ...
                            <h4 class="text-xl font-bold">Professional K-9 Unit Shorkot</h4>
                            <p class="text-sm">
                                Our highly trained dogs are experts in detection and tracking in Shorkot
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden">
                <div class="bg-gradient-to-r from-teal-500 to-teal-300 py-4 px-6">
                    <h3 class="text-white text-center text-2xl font-bold">
                        Our Professional Services in Shorkot
                    </h3>
                </div>
        ...
        <div data-aos="fade-up" class="mb-10">
            <div class="bg-gradient-to-r from-teal-500 to-teal-300 rounded-xl p-8 shadow-lg text-center">
                <h3 class="text-white text-2xl font-bold mb-4">
                    Need Professional Dog Services in Shorkot?
                </h3>
                <p class="text-cyan-100 mb-6 max-w-lg mx-auto">
                    Our team is available 24/7 to assist with any emergency situation in Shorkot.
