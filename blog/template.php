...
<html lang="en"><head>
    ...
    <base href="https://blog.armydogcenter.org.pk/" />

    <!-- SEO Optimization -->
    <title><?= htmlspecialchars($post['title']) ?> | Army Dog Center Pakistan</title>
    ...
    <link rel="sitemap" type="application/xml" title="Sitemap" href="https://blog.armydogcenter.org.pk/sitemap.xml" />
    <meta name="DC.title" content="<?= htmlspecialchars($post['title']) ?>">
    <meta name="DC.subject" content="Military Working Dogs">
    <meta name="DC.creator" content="Army Dog Center Pakistan">

    <!-- Open Graph / Social Media -->
    <meta property="og:title" content="<?= htmlspecialchars($post['title']) ?> | Army Dog Center Pakistan">
  ...
  <meta property="og:image" content="https://armydogcenter.org.pk/images/dogimg-14.jpeg">
    ...
    <meta name="twitter:title" content="<?= htmlspecialchars($post['title']) ?> | Army Dog Center Pakistan">
    ...
    <meta name="twitter:image" content="https://armydogcenter.org.pk/images/logo.webp">
    ...
    <script type="application/ld+json">
        {
            ...
            "image": "https://armydogcenter.org.pk/images/post-image.webp",
            "author": {
                "@type": "Organization",
            ...
            "publisher": {
                ...
                "logo": {
                    "@type": "ImageObject",
                    "url": "https://armydogcenter.org.pk/images/logo.webp"
                }
            },
            "url": "<?= $post['url']; ?>"
        }
                    ...
                    <address class="flex items-center mb-6 not-italic">
                        <div class="inline-flex items-center mr-3 text-sm text-gray-900">
                            <img class="mr-4 w-16 h-16 rounded-full"
                                src="https://armydogcenter.org.pk/images/logo.webp" alt="Army Dog Center">
                            <div>
