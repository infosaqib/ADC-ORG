...
<head>
    ...
    <meta property="og:description" content="        
            ...
            ">
    <meta property="og:url" content="https://services.armydogcenter.org.pk/port-qasim-karachi.php" />
    <meta property="og:type" content="website" />
    <meta property="og:image" content="https://armydogcenter.org.pk/images/services/sindh/port-qasim-karachi.jpeg" />
    ...
    <meta name="twitter:description" content="        
            ...
            ">
    <meta name="twitter:image" content="https://armydogcenter.org.pk/images/services/sindh/port-qasim-karachi.jpeg" />
    ...
    <link rel="canonical" href="https://services.armydogcenter.org.pk/port-qasim-karachi.php" />
    ...
    <script type="application/ld+json">
    {
        ...
        "@graph":[
            ...
            {
                "@type":"WebPage",
                "@id":"https://services.armydogcenter.org.pk/port-qasim-karachi.php#webpage",
                "url":"https://services.armydogcenter.org.pk/port-qasim-karachi.php",
                "name":"Army Dog Center Port Qasim Karachi",
                "description":"Professional dog services in Port Qasim Karachi including crime investigation, evidence detection, and security services with trained dogs available 24/7.",
        ...
        <div data-aos="fade-up" class="mb-10">
            <div class="bg-white p-2 rounded-xl shadow-md">
                <h3 class="text-2xl font-bold text-teal-500 mb-6 text-center">
                    Our Trained Dogs in Port Qasim Karachi
                </h3>
                <div class="flex justify-center">
                    <div
                        ...
                        <img src="https://armydogcenter.org.pk/images/services/sindh/port-qasim-karachi.jpeg"
                        ...
                        <div
                            ...
                            <h4 class="text-xl font-bold">Professional K-9 Unit Port Qasim Karachi</h4>
                            <p class="text-sm">
                                Our highly trained dogs are experts in detection and tracking in Port Qasim Karachi
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden">
                <div class="bg-gradient-to-r from-teal-500 to-teal-300 py-4 px-6">
                    <h3 class="text-white text-center text-2xl font-bold">
                        Our Professional Services in Port Qasim Karachi
                    </h3>
                </div>
        ...
        <div data-aos="fade-up" class="mb-10">
            <div class="bg-gradient-to-r from-teal-500 to-teal-300 rounded-xl p-8 shadow-lg text-center">
                <h3 class="text-white text-2xl font-bold mb-4">
                    Need Professional Dog Services in Port Qasim Karachi?
                </h3>
                <p class="text-cyan-100 mb-6 max-w-lg mx-auto">
                    Our team is available 24/7 to assist with any emergency situation in Port Qasim Karachi.
